...
class PW_CMB2_Field_Taxonomy_Select2 {
	 ...
	 */
	public function get_pw_taxonomy_options( $field_escaped_value, $field_type_object, $condition ) {
	...
	public function setup_admin_scripts() {
		...
		wp_enqueue_script( 'pw-taxonomy-select2-init', $asset_path . '/js/script.js', array( 'cmb2-scripts', 'wpcd-select2', 'jquery-ui-sortable' ), self::VERSION );
		wp_enqueue_style( 'pw-taxonomy-select2-tweaks', $asset_path . '/css/style.css', array( 'wpcd-select2' ), self::VERSION );
	}
