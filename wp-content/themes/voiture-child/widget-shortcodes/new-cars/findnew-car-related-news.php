...
function car_related_news($atts)
{
    ...
    $news_posts_data = get_car_news_data($brand_id);
    ...
    $title = $brand_id != 0 ? esc_html('Tin tức Xe Ô Tô'. $brand_name . ' tại Việt Nam') : 'Tin tức Xe Ô Tô mới nhất';
?>
...
add_shortcode('car_related_news', 'car_related_news');
