...
?>
    ...
    <div class="view-more-container">
        <a href="<?php echo esc_url(home_url('/cars')); ?>" class="view-more-button"><?php echo esc_html__('View More', 'voiture'); ?> <span>&#8250;</span></a>
    </div>
    <style>
...
add_shortcode('findnew_car_brands', 'findnew_car_brands');
?>