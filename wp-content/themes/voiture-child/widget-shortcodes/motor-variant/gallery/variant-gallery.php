...
function motor_variant_gallery_shortcode()
{
    // global $post;
    global $wpdb;
    ...
    if (empty($images)) {
        return motor_showSwitchVariant($listing_post, $filtered_variants);
    }
...
?>
    <div class="gallery-tabs-container">
        <?php echo motor_showSwitchVariant($listing_post, $filtered_variants); ?>
        <!-- Tabs -->
...
add_shortcode('motor_variant_gallery', 'motor_variant_gallery_shortcode');

function motor_showSwitchVariant($listing_post, $filtered_variants)
{
    ob_start();
?>
