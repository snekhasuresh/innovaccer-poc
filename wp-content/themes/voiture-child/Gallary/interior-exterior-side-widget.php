<?php
function car_gallery_variants_side_shortcode()
{
    global $wpdb;
    ...
    foreach ($imageResults as $result) {
        ...
        if (isset($variantsdata[$variant_id]) && in_array($type, ['interior', 'exterior'])) {
    ...
    foreach ($variantsdata as $variant) {
        ...
        $total_images = ($variant['image_count']['interior'] ?? 0) + ($variant['image_count']['exterior'] ?? 0);
...
add_shortcode('car_gallery_variants', 'car_gallery_variants_side_shortcode');
