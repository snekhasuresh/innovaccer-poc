...
function enqueue_motor_brand_description_css()
{
    wp_enqueue_style('motor_brand-description-style', get_stylesheet_directory_uri() . '/widget-shortcodes/new-cars/css/brand-description.css', array(), '1.0', 'all');
}

function bike_brand_description_shortcode($atts)
{
    enqueue_motor_brand_description_css();
    ...
    $brand_data = get_motor_brand_description_data($atts['brand_id']);
...
add_shortcode('bike_brand_description', 'bike_brand_description_shortcode');
