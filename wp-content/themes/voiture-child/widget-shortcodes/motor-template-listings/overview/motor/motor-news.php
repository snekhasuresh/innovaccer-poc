    ...
    $args = array(
        ...
        'meta_query' => array(
            array(
                ...
                'value' => 's:' . strlen((string) $bike_post->ID) . ':"' . $bike_post->ID . '";',
                'compare' => 'LIKE'
            ),
            array(
                'key'     => 'second_language',
...
?>
        <div id="listing-detail-description" class="description inner">
                ...
                ?>
                    <div class="news-card" data-url="<?php echo $post_data['link']; ?>">
                        ...
                        <div class="news-content">
                            <p class="car-model-varient-news"><span class="car-brand-icon">•</span> <?php echo esc_html($bike_post->post_title); ?></p>
            ...
            <?php do_action('wp-cardealer-single-listing-description', $bike_post); ?>
            <script>
...
add_shortcode('single_listing_motor_news_shortcode', 'single_listing_motor_news_shortcode');
