            ...
            function updateMotorComparison(selectedVariants) {
                ...
                if (selectedCars.length < 2) {
                    ...
                    const translations = {
                        ...
                        horsepower: "Tenaga Maksimal",
                        year: "Launch Time",
                        engine_type: "Jenis Mesin",
                        start_option: "Opsi start",
                        body_type: "Kategori",
                        on_sale: "Status penjualan",
                        fuel_consumption: "Konsumsi Bahan Bakar(L/100km)",
                        fuel_type: "Jenis Bahan Bakar",
                        transmission: "Jenis Transmisi",
                        maximum_speed: "Kecepatan maksimum",
                        rpm_maximum_torque: "RPM torsi maksimum(RPM)",
                        number_of_cylinders: "Jumlah silinder",
                        rpm_maximum_power: "RPM Tenaga Maksimum(RPM)",
                        valve_per_cylinder: "Katup Per Silinder",
                        maximum_power: "Tenaga Maksimal(PS)",
                        maximum_torque: "Torsi Maksimal(Nm)",
                        coupling_type: "Jenis Kopling",
                        wheelbase: "Wheelbase(mm)",
                        length: "Panjang(mm)",
                        height: "Tinggi(mm)",
                        width: "Lebar(mm)",
                        weight: "Bobot",
                        seat: "Kapasitas Tempat Duduk",
                        capacity: "Kapasitas(cc)",
                        fuel_tank_capacity: "Kapasitas Tangki Oli",
                        gear_box: "Gear Box",
                        transmission: "Jenis Transmisi",
                        jenis_penggerak: "Jenis Penggerak",
                        ground_clearance: "Ground Clearance",
                        chair_height: "Ketinggian Jok",
                        rear_suspension: "Suspensi Belakang",
                        front_suspension: "Suspensi Depan",
                        electronic_suspension_adjustment: "Electronic Suspension Adjustment",
                        head_lamp: "Head Lamp",
                        indicator_light: "Indikator Lampu",
                        taillight: "Lampu Belakang",
                        oil_change_indicator: "Indikator Penggantian Oli",
                        instrument_panel: "Panel Instrumen",
                        tachometer: "Tachometer",
                        display_screen: "Layar Display",
                        rear_wheel_size: "Ukuran velg belakang",
                        front_wheel_size: "Ukuran velg depan",
                        ...
                        engine_check_warning: "Engine Check Warning",
                        traction_control: "Traction Control",
                        driving_mode: "Mode Berkendara",
                        cruise_control: "Cruise Control",
                        changer_type: "Tipe Charger",
                        pack_capacity: "Pack Capacity",
                        battery_charging_time: "durasi pengisian baterai",
                        pack_life: "Pack Life",
