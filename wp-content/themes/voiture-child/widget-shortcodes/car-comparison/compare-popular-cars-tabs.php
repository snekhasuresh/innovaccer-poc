<?php
function enqueue_compare_cars_css()
{
    ...
    wp_enqueue_style('compare-popular-car-tabs-css', get_stylesheet_directory_uri() . '/widget-shortcodes/car-comparison/css/compare-popular-car-tabs.css');
}


function compare_cars_comparison_page()
{
    enqueue_compare_cars_css();
    ...
    if (empty($popular_cars) && empty($latest_cars)) {
        return;
    }
    ...
    <div class="recommended-multi-car-tabs">
        ...
        <div class="recommended-multi-tab-content">
            <div id="recommended-multi-popular-content" class="recommended-multi-tab-pane">
                ...
                <?php display_recommendedcar_posts_compare_page($popular_cars); ?>
            </div>
            <div id="recommended-multi-latest-content" class="recommended-multi-tab-pane">

                <?php display_recommendedcar_posts_compare_page($latest_cars); ?>
            </div>
        </div>
    </div>
...
add_shortcode('compare_popular_cars', 'compare_cars_comparison_page');

function display_recommendedcar_posts_compare_page($posts)
{
        ...
        <div class="single-listing-car-list">
            <?php foreach ($compare_cars_array as $compare_cars) : ?>
                <div class="findnew-comparison-item">
                    ...
                    <a href=<?php echo esc_url(home_url('/compare-cars/') . $compare_cars['comparison_url']); ?> class="findnew-compare-button">
