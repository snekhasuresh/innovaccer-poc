...
wp_enqueue_script( 'jquery-datetimepicker', WP_CARDEALER_PLUGIN_URL . '/assets/js/jquery.datetimepicker.full.min.js', array( 'jquery' ), '20150330', true );
wp_enqueue_style( 'jquery-datetimepicker', WP_CARDEALER_PLUGIN_URL . '/assets/css/jquery.datetimepicker.min.css' );
    ...
    <div class="form-group-inner inner">
	    ...
	    <div class="date-from-wrapper">
		    ...
		    <input type="text" name="<?php echo esc_attr($name); ?>[from]" class="form-control field-datetimepicker"
		           ...
		           id="<?php echo esc_attr( $args['widget_id'] ); ?>_<?php echo esc_attr($key); ?>" placeholder="<?php echo esc_attr(!empty($field['placeholder']) ? $field['placeholder'] : ''); ?> <?php esc_attr_e('Form', 'wp-cardealer'); ?>">
		</div>
		...
		<div class="date-to-wrapper">
		    ...
		    <input type="text" name="<?php echo esc_attr($name); ?>[to]" class="form-control field-datetimepicker"
		           value="<?php echo esc_attr($selected_to); ?>" placeholder="<?php echo esc_attr(!empty($field['placeholder']) ? $field['placeholder'] : ''); ?> <?php esc_attr_e('To', 'wp-cardealer'); ?>">
		</div>
