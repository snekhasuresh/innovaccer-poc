...
class PW_CMB2_Field_Taxonomy_Select2_Search {
	...
	public function __construct() {
		...
		// Ajax endpoints.
		add_action( 'wpcd_ajax_wpcd_search_terms',  array($this, 'search_terms') );
	}
	...
	public function setup_admin_scripts() {
		...
		wp_enqueue_script( 'pw-taxonomy-select2-loadmore-init', $asset_path . '/js/script.js', array( 'cmb2-scripts', 'wpcd-select2', 'jquery-ui-sortable' ), self::VERSION );
		wp_enqueue_style( 'pw-taxonomy-select2-loadmore-tweaks', $asset_path . '/css/style.css', array( 'wpcd-select2' ), self::VERSION );

		wp_localize_script( 'pw-taxonomy-select2-loadmore-init', 'wp_cardealer_tax_search_opts', array(
    ...
    public function get_terms($taxonomy, $query_args = array(), $per_page = 0, $page = 1) {
	    ...
	    $terms_hash = 'wpcd_cats_' . md5( wp_json_encode( $args ) . WP_CarDealer_Cache_Helper::get_transient_version('wpcd_get_' . $taxonomy) );
