...
function enqueue_find_new_car_faq_css()
{
...
function findnew_car_faqs_shortcode($atts)
{
    enqueue_find_new_car_faq_css();
    ...
    $faq_posts_data = get_car_faq_data($brand_name);
...
add_shortcode('findnew_car_faqs_shortcode', 'findnew_car_faqs_shortcode');
