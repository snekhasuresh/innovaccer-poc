...
class WP_CarDealer_Wc_Paid_Listings_Template_Loader {
	 ...
	 * @throws Exception
	 */
	public static function locate( $name, $plugin_dir = WP_CARDEALER_WC_PAID_LISTINGS_PLUGIN_DIR ) {
		$template = '';
		...
		$theme_folder_name = apply_filters( 'wp-cardealer-wc-paid-listings-theme-folder-name', 'wp-cardealer-wc-paid-listings' );
		// Child theme
	 ...
	 * @throws Exception
	 */
	public static function get_template_part( $name, $args = array(), $plugin_dir = WP_CARDEALER_WC_PAID_LISTINGS_PLUGIN_DIR ) {
