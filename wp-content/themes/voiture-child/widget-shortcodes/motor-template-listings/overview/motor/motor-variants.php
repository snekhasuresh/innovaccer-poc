<?php
function enqueue_overview_motor_variants_css()
{
    wp_enqueue_style('motor-overview-variants-style', get_stylesheet_directory_uri() . '/widget-shortcodes/motor-template-listings/overview/motor/css/variants.css', array(), '1.0', 'all');
}
// add_action('wp_enqueue_scripts', 'enqueue_overview_variants_css');

function single_listing_motor_variants()
{
    enqueue_overview_motor_variants_css();
    ...
    $lowest_price = PHP_INT_MAX; // Use a very high initial value
    ...
    foreach ($variant_posts as $variant_post) {
        ...
        if ($on_sale == 'Yes' && $state == 1) {
			...
			// Exclude 0 prices for the lowest price calculation
    ...
    // Handle the lowest price case where no valid prices exist
	...
	} elseif ($lowest_price == 0 && $highest_price != 0) {
		$price = 'THB ' . number_format($highest_price);
	} elseif ($lowest_price != 0 && $highest_price != 0) {
		$price = 'THB ' . number_format($lowest_price) . ' - ' . number_format($highest_price);
	} else {
    ...
    <div class="row">
        ...
        <div class="varient-page-container">
            <div id="listing-detail-description" class="description inner col-md-12">
                <h2 class=" wa-title-text"><?php esc_html_e('รุ่นย่อยและราคา ' .$post_title, 'voiture'); ?></h2>

                <div class="tabs-container-varient">
                    <?php if (!empty($variants_on_sale)) { ?>
                        <div class="price-dec"><?php echo $year_range . ' ' . $post_title . ' มีให้เลือกถึง ' . $variant_on_sale_count . ' รุ่นย่อยพร้อมราคาเริ่มต้นอยู่ที่ ' . $price . ', รุ่นเริ่มต้นของ ' . $post_title . ' คือ ' . $lowest_price_variant_name . '  ที่ราคา THB ' . $lowest_price . ' ส่วนรุ่นท็อปสุด ' . $post_title . ' มาพร้อมราคา ' . $highest_price_variant_name . ' THB ' . $highest_price ?>.</div>
                    <?php } ?>
                            ...
                            <div class="car-list-varient">
                                <?php foreach ($variants_on_sale as $variant) {
                                    ...
                                    $grouped_variants[$group_key][] = [
                                        ...
                                        'retail_price' => (isset($meta_data['price'][0]) && $meta_data['price'][0] != 0) ? 'THB' . format_number_with_commas($meta_data['price'][0]) : 'ยังไม่คอนเฟิร์ม',
										'monthly_payment' => (isset($meta_data['monthly_payment'][0]) && $meta_data['monthly_payment'][0] != 0) ? 'THB' . format_number_with_commas($meta_data['monthly_payment'][0]) : 'ยังไม่คอนเฟิร์ม',
                                    ];
                                }
                                wp_reset_postdata();
                                ...
                                ?>
                                    ...
                                    <?php foreach ($variants as $variant) { ?>
                                        <div class="car-item-c">
                                            ...
                                            $variant_url = $base_url . '/motorcycles/' . $make . '/' . $model . '/' . $variant['post_name'];
                                            ?>
                                            ...
                                            <div class="right-content">
                                                <div class="price-section">
                                                    ...
                                                    <div class="monthly-price">
                                                        <?php echo $variant['monthly_payment'] . '/เดือน'; ?>
                                                    </div>
                                                </div>
                                                <a href="<?php echo home_url('tools/motor-loan-calculator'); ?>" class="calculator-icon">
                                                ...
                                                <div class="actions">
                                                    <a href="<?php echo home_url('compare-motorcycles'); ?>" class="compare-btn"><?php esc_html_e('+ เปรียบเทียบ  ', 'your-textdomain'); ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
                        ...
                        <div id="tab-not-on-sale" class=" <?php echo (!empty($variants_not_on_sale) && empty($variants_on_sale)) ? 'active' : 'custom-tab-panel' ?>">
                            <div class="car-list-varient">
                                ...
                                ?>
                                    ...
                                    <?php foreach ($variants as $variant) { ?>
                                        <div class="car-item-c">
                                            <div class="car-name"><?php echo esc_html($variant['title']); ?></div>
                                            <div class="right-content">
                                                <div class="price-section">
                                                    <div class="total-price"><?php echo $variant['retail_price']; ?></div>
                                                    <div class="monthly-price"><?php echo $variant['monthly_payment'] . '/เดือน'; ?></div>
                                                </div>
                                                <a href="<?php echo home_url('tools/motor-loan-calculator'); ?>" class="calculator-icon">
                                                    <img src="data:image/svg+xml;base64," alt="">
                                                </a>
                                                <div class="actions">
                                                    <a href="#" class="compare-btn"><?php esc_html_e('+ เปรียบเทียบ ', 'your-textdomain'); ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
...
add_shortcode('single_listing_motor_variants', 'single_listing_motor_variants')
?>