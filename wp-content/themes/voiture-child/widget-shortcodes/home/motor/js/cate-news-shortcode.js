jQuery(document).ready(function ($) {
  ...
  $(document).on("click", ".home-pagination .prev-page, .home-pagination .next-page", function (e) {
    e.preventDefault();
    ...
    container.find(".home-pagination").hide();
    ...
    $.ajax({
      ...
      type: "POST",
      data: {
        action: "motor_cate_news_pagination",
        page: page,
        category: category,
      ...
      success: function (response) {
        ...
        if (response.success) {
          ...
          var newPagination = tempDiv.find(".home-pagination");
          ...
          if (newPagination.length > 0) {
            ...
            container.find(".home-pagination").replaceWith(newPagination);
          }
        } else {
      ...
      complete: function () {
        ...
        container.find(".home-pagination").show(); // Show the pagination
      },
    });
  });
});
