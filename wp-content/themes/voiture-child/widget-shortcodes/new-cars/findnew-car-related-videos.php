<?php
function enqueue_find_new_cars_videos_css()
{
    // Register and enqueue the CSS file
    wp_enqueue_style('find-new-cars-videos-style', get_stylesheet_directory_uri() . '/widget-shortcodes/new-cars/css/find-new-cars-videos.css', array(), '1.0', 'all');
}
...
function findnew_car_videos_carousal($atts)
{
    ...
    $videos = get_car_videos_data($brand_id);
...
add_shortcode('findnew_car_videos_carousal', 'findnew_car_videos_carousal');
