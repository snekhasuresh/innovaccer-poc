...
function enqueue_listing_gallery_carousel_styles()
{
...
{
    enqueue_listing_gallery_carousel_styles();
                ...
                foreach ($imageResults as $image) {
                    ...
                    if (!empty($images)) {
                        ...
                        if ($image->type == 'Interior' || $image->type == 'Others') {
                            $small_images[] = $images[0]['url']; // First image of the type
                        }
...
add_shortcode('filter_widget', 'filter_widget');
