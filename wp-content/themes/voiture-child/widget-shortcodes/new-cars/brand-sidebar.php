...
function enqueue_brand_sidebar_css()
{
...
function display_car_brands_alphabetically()
{
    enqueue_brand_sidebar_css();

    $brands_by_letter = get_brand_sidebar_data();
...
function car_brand_details_shortcode($atts) {
    ...
    <div id="car-brand-details" class="car-brand-details">
        <?php
        if ($is_new_cars_page) {
            render_new_cars_details($url);
        } else {
            render_default_car_details();
        }
        ?>
    </div>
    <?php
...
add_shortcode('car_brand_details', 'car_brand_details_shortcode');

function render_new_cars_details($url)
{
    ...
    $selected_filters = parse_filters_from_url($last_part, $filter_mapping);
...
function parse_filters_from_url($url, $filter_mapping)
{
...
function render_default_car_details()
{
...
function add_scripts_for_car_brands()
{
?>
...
function show_all_cars()
{
    ...
    echo '<div class="widget-container populor-car-brand-container" style="margin-bottom: 20px; margin-top: 20px;">';
    echo do_shortcode('[popular_cars_in_new_cars]');
    echo '</div>';
    ...
    echo '<div class="widget-container " style="margin-bottom: 20px; margin-top: 20px; ">';
    echo do_shortcode('[findnew_car_videos_carousal]');
    echo '</div>';
    ...
    // echo '<h2 class="wa-title-text" style="margin-left:10px;">Compare Cars</h2>';
    echo '<div class="widget-container" style="margin-bottom: 20px; margin-top: 20px; ">';
    ...
    echo '</div>';
    // echo '<h2 class="wa-title-text" style="margin-left:10px;">Car FAQs</h2>';
    echo '<div class="widget-container populor-car-brand-container" style="margin-bottom: 20px; margin-top: 20px">';
...
function apply_brand_filter($brand)
{
    ob_start();
    ...
    echo '<div class="widget-container" style="margin-bottom: 20px; margin-top: 20px;">';
    echo do_shortcode('[car_related_news brand_id="' . $brand->term_id . '"]');
    echo '</div>';

    // echo '<h2>' . $brand->name . ' Videos in Malaysia</h2>';
    echo '<div class="widget-container" style="margin-bottom: 20px; margin-top: 20px; ">';
    echo do_shortcode('[findnew_car_videos_carousal brand_id="' . $brand->term_id . '"]');
    echo '</div>';

    // echo '<h2 class="wa-title-text" style="margin-left:10px;">' . $brand->name . ' Car Comparison</h2>';
    echo '<div class="widget-container filtered-car-comparison-con" style="margin-bottom: 20px; margin-top: 20px; ">';
    echo do_shortcode('[findnew_car_comparison brand_id="' . $brand->term_id . '"]');
    echo '</div>';
    ...
    // echo '<h2 class="wa-title-text" style="margin-left:10px;">' . $brand->name . ' Car FAQs in Malaysia</h2>';
    echo '<div class="widget-container populor-car-brand-container" style="margin-bottom: 20px; margin-top: 20px">';
    echo do_shortcode('[findnew_car_faqs_shortcode brand_id="' . $brand->term_id . '"]');
    echo '</div>';
