...
<form method="get" action="<?php echo WP_CarDealer_Mixes::get_listings_page_url(); ?>" class="filter-listing-form filter-listing-form">
	<?php $fields = $fields_adv = WP_CarDealer_Listing_Filter::get_fields(); ?>
	...
	<?php if ( ! empty( $instance['show_adv_fields'] ) ) : ?>
		<div class="more-advanced clearfix">
			<a href="#toggle_adv" class="filter-toggle-adv text-theme visiable-line">
				<i class="fas fa-cog"></i> <span><?php esc_html_e('Advanced Search', 'wp-cardealer'); ?></span>
			</a>
		</div>
