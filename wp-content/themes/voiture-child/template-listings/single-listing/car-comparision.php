...
function enqueue_single_listing_car_comparison_css()
{
    wp_enqueue_style('car-comparison', get_stylesheet_directory_uri() . '/template-listings/single-listing/css/car-comparison.css', array(), '1.0.0', 'all');
}

function single_listing_car_comparison()
{
    enqueue_single_listing_car_comparison_css();
...
add_shortcode('single_listing_car_comparison', 'single_listing_car_comparison');
