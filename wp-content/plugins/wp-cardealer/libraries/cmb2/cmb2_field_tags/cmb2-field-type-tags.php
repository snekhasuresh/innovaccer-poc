...
class WP_CarDealer_CMB2_Field_Tags {

	public static function init() {
		add_filter( 'cmb2_render_wp_cardealer_tags', array( __CLASS__, 'render_map' ), 10, 5 );
		add_filter( 'cmb2_sanitize_wp_cardealer_tags', array( __CLASS__, 'sanitize_map' ), 10, 4 );	
	}
...
WP_CarDealer_CMB2_Field_Tags::init();