<?php
function enqueue_bike_video_carousal_css()
{
    wp_enqueue_style('bike-videos-carousal', get_stylesheet_directory_uri() . 'widget-shortcodes/new-motorcycle/css/find-news-videos-carousal.css');
}

function latest_bikes_videos_carousal($atts)
{
    enqueue_bike_video_carousal_css();
        ...
        <?php if ($video_query->have_posts()): ?>
            ...
            ?>
                ...
                <div class="latest-car-video" style="background-color: white; padding: 10px; margin-bottom: 20px; border: 1px solid #ccc; border-radius: 5px;">
                    ...
                    <h3 style="color: #262626; text-align: start; margin-top: 10px; font-size: 16px; line-height: 20px; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 2; white-space: normal; height: 40px; color: #262626;  font-weight: bold; margin-bottom:6px">
...
add_shortcode('latest_bikes_videos_carousal', 'latest_bikes_videos_carousal');
