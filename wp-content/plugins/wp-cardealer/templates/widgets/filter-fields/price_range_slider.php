    ...
    <div class="form-group-inner">
		...
		?>
	  	<div class="from-to-wrapper">
			...
			<span class="inner">
				<?php echo esc_html__('From','wp-cardealer'); ?>
				<span class="from-text"><?php echo WP_CarDealer_Price::format_price($min_val, true); ?></span>
				<span class="space"><?php echo esc_html__('to','wp-cardealer'); ?></span>
				<span class="to-text"><?php echo WP_CarDealer_Price::format_price($max_val, true); ?></span>
			</span>
		</div>
