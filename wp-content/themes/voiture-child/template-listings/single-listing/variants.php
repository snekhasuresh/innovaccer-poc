            ...
            <div id="listing-detail-description" class="description inner col-md-12">
                ...
                <div class="tabs-container-varient">
                    <?php if (!empty($variants_on_sale)) { ?>
                       <div class="price-dec">
    <?php 
    echo $year_range . ' ' . $post_title . ' มีให้เลือกทั้งหมด ' . $variant_on_sale_count . 
    ' รุ่นย่อย พร้อมราคาตั้งแต่ ' . $price . ' ถึง THB ' . $highest_price . 
    ' รุ่นเริ่มต้นของ ' . $post_title . ' คือ ' . $lowest_price_variant_name . 
    ' ในราคา THB ' . $lowest_price . ' ส่วนรุ่นท็อปสุด ' . $post_title . 
    ' มีราคาอยู่ที่ THB ' . $highest_price . '.'; 
    ?>
</div>
                    <?php } ?>
                            ...
                            <div class="car-list-varient">
                                <?php foreach ($variants_on_sale as $variant) {
                                    ...
                                    $grouped_variants[$group_key][] = [
                                        ...
                                        'retail_price' => (isset($meta_data['retail_price'][0]) && $meta_data['retail_price'][0] != 0) ? 'THB ' . format_number_with_commas($meta_data['retail_price'][0]) : 'ยังไม่คอนเฟิร์ม',
                                ...
                                ?>
                                    ...
                                    <?php foreach ($variants as $variant) { ?>
                                        <div class="car-item-c">
                                            ...
                                            $variant_url = $base_url . '/cars/' . $make . '/' . $model . '/' . $variant['post_name'];
                                            ?>
                                            ...
                                            <div class="right-content">
                                                ...
                                                <div class="actions">
                                                    <a href="<?php echo home_url('compare-cars'); ?>" class="compare-btn"><?php esc_html_e('+ เปรียบเทียบ  ', 'your-textdomain'); ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
